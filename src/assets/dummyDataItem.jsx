    ...
    items: [
      {
        ...
        price: 180,
        image: ApplesImg,
        description: "Tropical pink fruit with white flesh",
      },
      {
        id: 102,
        name: "Passion Fruit",
        price: 150,
        image: CarrotsImg,
        description: "Tangy tropical fruit with aromatic pulp",
      },
      {
        id: 103,
        name: "Star Fruit",
        price: 120,
        image: AvocadoImg,
        description: "Star-shaped yellow fruit with crisp texture",
      },
      {
        id: 104,
        name: "Persimmon",
        price: 140,
        image: BroccoliImg,
        description: "Sweet orange fruit with honey-like flavor",
      },
      {
        id: 105,
        name: "Kiwano Melon",
        price: 200,
        image: BananasImg,
        description: "Horned melon with vibrant green jelly",
      },
      {
        id: 106,
        name: "Rambutan",
        price: 160,
        image: TomatoesImg,
        description: "Hairy red fruit with translucent flesh",
      },
      {
        id: 107,
        name: "Mangosteen",
        price: 220,
        image: PeppersImg,
        description: "Purple fruit with snow-white segments",
      },
      {
        id: 108,
        name: "Pomelo",
    ...
    items: [
      {
        ...
        price: 480,
        image: MilkImg,
        description: "Creamy brie infused with black truffle",
      },
      {
        id: 202,
        name: "Aged Gouda",
        price: 420,
        image: EggsImg,
        description: "5-year aged Dutch cheese with caramel notes",
      },
      {
        id: 203,
        name: "Smoked Blue",
        price: 380,
        image: YogurtImg,
        description: "Blue cheese cold-smoked over hickory",
      },
      {
        id: 204,
        name: "Himalayan Yak",
        price: 650,
        image: CheeseImg,
        description: "Rare cheese from high-altitude yak milk",
      },
      {
        id: 205,
        ...
        price: 520,
        image: PaneerImg,
        description: "Spanish sheep cheese with saffron threads",
      },
      {
        id: 206,
        ...
        price: 450,
        image: ButterImg,
        description: "Sharp cheddar aged in whiskey barrels",
      },
      {
        id: 207,
        ...
        price: 490,
        image: CreamImg,
        description: "Swiss cheese aged in mountain caves",
      },
      {
        id: 208,
        name: "Lavender Goat",
        price: 380,
        image: LassiImg,
        description: "Fresh goat cheese with edible lavender",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        price: 120,
        image: BreadImg,
        description: "Italian olive oil bread with rosemary",
      },
      {
        id: 302,
        name: "Turkish Simit",
      ...
      },
      {
        ...
        price: 150,
        image: MuffinImg,
        description: "Super-soft, pillowy shokupan",
      },
      {
        id: 304,
        name: "Indian Naan",
        price: 70,
        image: BagelImg,
        description: "Tandoor-baked leavened flatbread",
      },
      {
        id: 305,
        name: "Mexican Concha",
        price: 80,
        image: SconeImg,
        description: "Sweet bread with shell-patterned topping",
      },
      {
        id: 306,
        name: "Swedish Limpa",
        price: 110,
        image: DonutImg,
        description: "Rye bread with orange zest and fennel",
      },
      {
        id: 307,
        name: "Moroccan Khobz",
        price: 95,
        image: BaguetteImg,
        description: "Traditional semolina country bread",
      },
      {
        id: 308,
        ...
        price: 130,
        image: BriocheImg,
        description: "Sourdough flatbread with spongy texture",
      },
    ],
  },
  {
